    ...
    <section class="mb-4 contact">
      ...
      <div class="row">
        ...
        <div class="col-md-9 mb-md-0 mb-5">
          <form id="contact-form" name="contact-form" action="" onsubmit="return validateContact()" method="POST">
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                ...
                <div class="text-center text-md-left">
                  <div class="g-recaptcha" data-sitekey="6Lcw18EaAAAAAJszeQBsjPpxLuxGwJp0vyOGxtNJ"></div>
                  <input type="submit" class="btn btn-primary" onclick="validateContact()"></input>
